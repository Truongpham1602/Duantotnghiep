        ...
        <>
            <div className="sb-nav-fixed">
                <nav className="sb-topnav navbar navbar-expand navbar-dark bg-dark">
                    ...
                    <NavLink className="navbar-brand ps-3" to="/" activeClassName="active" exact={true}>Home</NavLink>
                    ...
                    <ul className="navbar-nav ms-auto ms-md-0 me-3 me-lg-5">
                        <li className="nav-item dropdown">
                            ...
                            <ul className="dropdown-menu" aria-labelledby="navbarDropdown">
                                <li><NavLink className="dropdown-item" to="/product" activeClassName="active" exact={true}>Action</NavLink></li>
                                <li><NavLink className="dropdown-item" href="#">Another action</NavLink></li>
                                <li><hr className="dropdown-divider" /></li>
                                <li><NavLink className="dropdown-item" href="#">Something else here kkk</NavLink></li>
                            </ul>
                        </li>
                    </ul>
                </nav>
                                ...
                                <div className="nav">
                                    ...
                                    <div className="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                        <nav className="sb-sidenav-menu-nested nav">
                                            ...
                                            <NavLink className="nav-link" href="#">Light Sidenav</NavLink>
                                        </nav>
                                    </div>
                                        ...
                                        <nav className="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
                                            ...
                                            <div className="collapse" id="pagesCollapseAuth" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordionPages">
                                                <nav className="sb-sidenav-menu-nested nav">
                                                    ...
                                                    <NavLink className="nav-link" href="#">Forgot Password</NavLink>
                                                </nav>
                                            </div>
                                            <NavLink className="nav-link collapsed" href="#" data-bs-toggle="collapse" data-bs-target="#pagesCollapseError" aria-expanded="false" aria-controls="pagesCollapseError">
                                                Error
                                                <div className="sb-sidenav-collapse-arrow"><i className="fas fa-angle-down"></i></div>
                                            </NavLink>
                                            <div className="collapse" id="pagesCollapseError" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordionPages">
                                                <nav className="sb-sidenav-menu-nested nav">
                                                    <NavLink className="nav-link" href="#">401 Page</NavLink>
                                                    <NavLink className="nav-link" href="#">404 Page</NavLink>
                                                    <NavLink className="nav-link" href="#">500 Page</NavLink>
                                                </nav>
                                            </div>
                                        </nav>
                                    </div>
                        ...
                        <footer className="py-4 bg-light mt-auto">
                            <div className="container-fluid px-4">
                                <div className="d-flex align-items-center justify-content-between small">
                                    <div className="text-muted">Copyright &copy; LuTra Website 2022</div>
                                    <div>
