...
public class SecurityUtilities {
    ...
    public static PrivateKey getPrivateKey(String resourceName) throws IOException {
        InputStream stream = SecurityUtilities.class.getClassLoader().getResourceAsStream(resourceName);
    ...
    public static PublicKey getPublicKey(String resourceName) throws IOException {
        InputStream inputStream = SecurityUtilities.class.getClassLoader().getResourceAsStream(resourceName);
