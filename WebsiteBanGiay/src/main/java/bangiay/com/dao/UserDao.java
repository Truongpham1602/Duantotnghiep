...
public interface UserDao extends JpaRepository<User, Integer>{
	@Query("SELECT u FROM User u WHERE u.email= :email OR u.telephone=:telephone")
	User findUserByEmailOrTelePhone(@Param("email")String email , @Param("telephone")String telephone);
